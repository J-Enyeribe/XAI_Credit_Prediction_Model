...
try:
    ...
    # Load pre-saved feature-engineered data slices (generated by save_background_data.py)
    # This replaces the raw CSV dependency so production never needs the original file.
    X_raw      = joblib.load(os.path.join(Config.MODEL_DIR, "X_raw.joblib"))
    X_test_raw = joblib.load(os.path.join(Config.MODEL_DIR, "X_test.joblib"))
    y_test_raw = joblib.load(os.path.join(Config.MODEL_DIR, "y_test.joblib"))
    ...
    # Fairness Auditor — initialised on saved test set
